...
from prototype_functions import get_SpO2_values, get_R_values, acceleration, get_datetime, get_testing_data, data_shuffle, calc_coefficients_SVR, calc_coefficients_LR, calc_coefficients_HR, calc_coefficients_RANSAC
...
folder = 'SpO2/Pilot Data/session'+Session+'/subject'+Subject+'/episode'+Episode+'/'
...
R = np.array([R[x] for x in range(0,len(SpO2)) if SpO2[x] >= 90])
